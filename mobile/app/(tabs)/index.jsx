...
import { View, TouchableOpacity, Text,  ScrollView, FlatList, RefreshControl } from 'react-native'
...
const HomeScreen = ()=>{
  ...
  const loadData = async ()=>{
    try {
      ...
      if(!selectedCategory) setSelectedCategory(transformedCategories[3].name)
...
const handleCaegorySelect = async (category)=>{
      ...
      >
        ...
        {categories.length > 0 && (
          <CategoryFilter 
            ...
            onSelectCategory={handleCaegorySelect}
          />
        )}
